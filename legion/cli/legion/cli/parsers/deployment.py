...
def generate_parsers(main_subparser: argparse._SubParsersAction) -> None:  # pylint: disable=R0915
    ...
    md_create_parser.add_argument('--min-replicas', default=0, type=int, help='min number of instances')
    md_create_parser.add_argument('--max-replicas', default=1, type=int, help='max number of instances')
    ...
    md_edit_parser.add_argument('--min-replicas', default=0, type=int, help='min number of instances')
    md_edit_parser.add_argument('--max-replicas', default=1, type=int, help='max number of instances')
