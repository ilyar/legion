...
def _add_model_discovery_params(parser: argparse.ArgumentParser):
    parser.add_argument('--model-route', '--mr', type=str, help='Name of Model Route')
    parser.add_argument('--model-deployment', '--md', type=str, help='Name of Model Deployment')
    parser.add_argument('--url', type=str, help='Url of model server')
    parser.add_argument('--url-prefix', type=str, help='Url of model server')
    parser.add_argument('--host', type=str, default=config.MODEL_SERVER_URL, help='Host of edge')
