...
def get_variables(arg: typing.Optional[str] = None, profile: typing.Optional[str] = None):
    ...
    variables = {
        ...
        'GRAFANA_URL': os.getenv('EDI_URL', f'https://grafana.{host_base_domain}'),
        'PROMETHEUS_URL': os.getenv('EDI_URL', f'https://prometheus.{host_base_domain}'),
        'ALERTMANAGER_URL': os.getenv('EDI_URL', f'https://alertmanager.{host_base_domain}'),
        'DASHBOARD_URL': os.getenv('EDI_URL', f'https://dashboard.{host_base_domain}'),
    }
